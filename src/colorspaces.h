...
*/
void 
yuv420_to_yuyv (unsigned char *framebuffer, unsigned char *tmpbuffer, int width, int height);
...
*/
void 
yyuv_to_yuyv (unsigned char *framebuffer, unsigned char *tmpbuffer, int width, int height);
