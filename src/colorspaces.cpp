...
#include <math.h>
double CLIP(double x) { return floor(x); }

/*------------------------------- Color space conversions --------------------*/
/* regular yuv (YUYV) to rgb24*/
void 
yuyv2rgb (unsigned char *pyuv, unsigned char *prgb, int width, int height)
{
	int l=0;
...
void 
yuyv2bgr1 (unsigned char *pyuv, unsigned char *pbgr, int width, int height)
{
...
void 
yuyv2bgr (unsigned char *pyuv, unsigned char *pbgr, int width, int height)
{
...
static inline void convert_packed_to_16bit(unsigned char *raw, unsigned short int *unpacked, int vw, int unpacked_len)
{
	int mask = (1 << vw) - 1;
...
*/
void y10b_to_yuyv (unsigned char *framebuffer, unsigned char *tmpbuffer, int width, int height)
{
	unsigned short int *unpacked_buffer = NULL;
	unsigned short int *ptmp;
	int h = 0;
	int w = 0;

	unpacked_buffer = (unsigned short int *)malloc(width * height * sizeof(unsigned short int));
	...
	for (h = 0; h < height; h++)
	{
		...
		{
			/* Y0 */
			*framebuffer++ = (unsigned char) ((ptmp[0] & 0x3FF) >> 2);
			/* U */
			*framebuffer++ = 0x80;
			/* Y1 */
			*framebuffer++ = (unsigned char) ((ptmp[1] & 0x3FF) >> 2);
			/* V */
			*framebuffer++ = 0x80;
...
*      height: picture height
*/
void y16_to_yuyv (unsigned char *framebuffer, unsigned char *tmpbuffer, int width, int height)
{
	unsigned short int *ptmp= (unsigned short int *) tmpbuffer;
	...
	for(h=0;h<height;h++) 
	{
		...
		{
			/* Y0 */
			*framebuffer++ = (unsigned char) ((ptmp[0] & 0xFF00) >> 8);
			/* U */
			*framebuffer++ = 0x80;
			/* Y1 */
			*framebuffer++ = (unsigned char) ((ptmp[1] & 0xFF00) >> 8);
			/* V */
			*framebuffer++ = 0x80;
...
*      height: picture height
*/
void yyuv_to_yuyv (unsigned char *framebuffer, unsigned char *tmpbuffer, int width, int height)
{
	unsigned char *ptmp=NULL;
	unsigned char *pfmb=NULL;
	ptmp = tmpbuffer;
	pfmb = framebuffer;
...
*      height: picture height
*/
void uyvy_to_yuyv (unsigned char *framebuffer, unsigned char *tmpbuffer, int width, int height)
{
	unsigned char *ptmp = tmpbuffer;
	unsigned char *pfmb = framebuffer;
	int h=0;
	int w=0;
...
*      height: picture height
*/
void yvyu_to_yuyv (unsigned char *framebuffer, unsigned char *tmpbuffer, int width, int height)
{
	unsigned char *ptmp=NULL;
	unsigned char *pfmb=NULL;
	ptmp = tmpbuffer;
...
*      height: picture height
*/
void yuv420_to_yuyv (unsigned char *framebuffer, unsigned char *tmpbuffer, int width, int height) 
{
	unsigned char *py;
	unsigned char *pu;
	unsigned char *pv;
...
*      height: picture height
*/
void yvu420_to_yuyv (unsigned char *framebuffer, unsigned char *tmpbuffer, int width, int height) 
{
	unsigned char *py;
	unsigned char *pv;
	unsigned char *pu;
...
*      height: picture height
*/
void nv12_to_yuyv (unsigned char *framebuffer, unsigned char *tmpbuffer, int width, int height) 
{
	unsigned char *py;
	unsigned char *puv;
...
*      height: picture height
*/
void nv21_to_yuyv (unsigned char *framebuffer, unsigned char *tmpbuffer, int width, int height) 
{
	unsigned char *py;
	unsigned char *puv;
...
*      height: picture height
*/
void nv16_to_yuyv (unsigned char *framebuffer, unsigned char *tmpbuffer, int width, int height)
{
	unsigned char *py;
	unsigned char *puv;
...
*      height: picture height
*/
void nv61_to_yuyv (unsigned char *framebuffer, unsigned char *tmpbuffer, int width, int height)
{
	unsigned char *py;
	unsigned char *puv;
...
*      height: picture height
*/
void y41p_to_yuyv (unsigned char *framebuffer, unsigned char *tmpbuffer, int width, int height)
{
	int h=0;
	int w=0;
...
*      height: picture height
*/
void grey_to_yuyv (unsigned char *framebuffer, unsigned char *tmpbuffer, int width, int height)
{
	int h=0;
	int w=0;
	int offset = 0;
...
*      height: picture height
*/
void s501_to_yuyv(unsigned char *framebuffer, unsigned char *tmpbuffer, int width, int height)
{
...
*      height: picture height
*/
void s505_to_yuyv(unsigned char *framebuffer, unsigned char *tmpbuffer, int width, int height)
{
	unsigned char *U, *V, *Y0, *Y1;
	unsigned char *line2;
	int h, w;
...
*      height: picture height
*/
void s508_to_yuyv(unsigned char *framebuffer, unsigned char *tmpbuffer, int width, int height)
{
	unsigned char *U, *V, *Y0, *Y1;
	unsigned char *line2;
	int h, w;
...
static void convert_border_bayer_line_to_bgr24( unsigned char* bayer, unsigned char* adjacent_bayer,
	unsigned char *bgr, int width, gboolean start_with_green, gboolean blue_line)
{
	int t0, t1;
...
static void bayer_to_rgbbgr24(unsigned char *bayer,
	...
	gboolean start_with_green, gboolean blue_line)
{
	...
	for (height -= 2; height; height--) 
	{
		...
		unsigned char *bayerEnd = bayer + (width - 2);
...
*/
void 
bayer_to_rgb24(unsigned char *pBay, unsigned char *pRGB24, int width, int height, int pix_order)
{
	switch (pix_order) 
	{
...
void
rgb2yuyv(unsigned char *prgb, unsigned char *pyuv, int width, int height) 
{
...
void
bgr2yuyv(unsigned char *pbgr, unsigned char *pyuv, int width, int height) 
{
